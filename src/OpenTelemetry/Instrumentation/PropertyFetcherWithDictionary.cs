// <copyright file="PropertyFetcherWithDictionary.cs" company="OpenTelemetry Authors">
...
namespace OpenTelemetry.Instrumentation
{
    ...
    public class PropertyFetcherWithDictionary<T>
    {
        private readonly string propertyName;
        private ConcurrentDictionary<Type, PropertyFetch> innerFetcher = new ConcurrentDictionary<Type, PropertyFetch>();

        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyFetcherWithDictionary{T}"/> class.
        /// </summary>
        /// <param name="propertyName">Property name to fetch.</param>
        public PropertyFetcherWithDictionary(string propertyName)
        {
